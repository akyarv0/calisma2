...
// const info1 = data.results.map(({name:{first}, location:{street:{name}}, dob:{age} }) => ({first, street: {name}, age}));
// console.log(info1);
...
const [obj] = data
console.log(obj.id);
const allId = data.map((m)=> console.log(m.color))

// const allId = data.map((m) => ({ id: m.id, color: m.color }));
// console.log(allId);
...
// 1) sampleObject içindeki name ve age değerlerini destructuring kullanarak ayrı değişkenlere atayın.


// 2) sampleObject içindeki ilk adresin şehir değerini firstCity adlı bir değişkene atayın.


// 3) sampleObject içindeki ikinci adresin posta kodu değerini secondZip adlı bir değişkene atayın.


// 4) sampleObject içindeki contact object'ini destructuring kullanarak ayrı bir değişkene atayın.


// 5) sampleObject içindeki contact object'indeki email değerini emailAddress adlı bir değişkene atayın.